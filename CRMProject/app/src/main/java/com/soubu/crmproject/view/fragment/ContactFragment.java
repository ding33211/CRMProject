...
public class ContactFragment extends FragmentPresenter<ContactActivityDelegate> {
...
//    }
    ...
    public void setPublicArgument(int from, String customerId){
        mFrom = from;
...
//                    intent.putExtra(Contants.EXTRA_CUSTOMER_ID, getActivity().getIntent().getStringExtra(Contants.EXTRA_CUSTOMER_ID));
//                    intent.putExtra(Contants.EXTRA_CUSTOMER_NAME, getActivity().getIntent().getStringExtra(Contants.EXTRA_CUSTOMER_NAME));
        ...
        viewDelegate.setOnRecyclerViewItemClickListener(new BaseWithFooterRvAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View v, int pos) {
                ...
                if(mFrom == Contants.FROM_ADD_SOMETHING_ACTIVITY){
                    ...
                    mGoto = GO_TO_EDIT;
                    Intent intent = new Intent(getActivity(), ContactSpecActivity.class);
        ...
        viewDelegate.setOnPhoneIconCLickListener(new BaseWithFooterRvAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View v, int pos) {
                ...
                if (!TextUtils.isEmpty(param.getMobile()) && !TextUtils.isEmpty(param.getPhone())) {
                    ...
                    AlertDialog dialog = new AlertDialog.Builder(getActivity()).setTitle(R.string.please_choose_phone)
...
//                    startActivity(intent);
    ...
    protected void initData() {
        super.initData();
        mContactDao = DBHelper.getInstance(getContext()).getContactDao();
