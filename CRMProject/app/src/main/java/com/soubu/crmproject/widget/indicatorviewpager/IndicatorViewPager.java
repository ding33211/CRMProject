 ...
 */
package com.soubu.crmproject.widget.indicatorviewpager;
...
import com.soubu.crmproject.adapter.PerformanceGoalAdapter;
...
//			} else {
			...
			Log.e("xxxxxxx", "select    :   " + select);
			Log.e("xxxxxxx", "preSelect    :   " + preSelect);

			if(adapter instanceof PerformanceGoalAdapter){
					((PerformanceGoalAdapter)adapter).restartCurrentValuesAnim(viewPager, preSelect, select);
				}
//			}
